...
export function useAppointmentModalParams() {
  ...
  const tab = getString(params[APPOINTMENT_PARAM_KEYS.TAB]);
  ...
  // 'new' param signals intent to open Booking Form for a new appointment and clear previous data
  ...
  return { tab, initialClientId, initialClientName, initialClientPhone, autoOpenDrawer, newAppointment, initialSlotStart, initialSlotEnd, initialRoomId, initialDate };
}
